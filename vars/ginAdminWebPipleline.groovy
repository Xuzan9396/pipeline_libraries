        ...
        post {
            success {
                ...
                script {
                    ...
                    def messageToSend = "web ${projectName}:${env.BRANCHNAME} ${VERSION} ${env.CommitMessage} commit_id: ${env.GIT_COMMIT}"
//                     messageToSend = messageToSend.replaceAll("#", "") // 去除所有的#字符
            ...
            failure {
                ...
                script {
                    ...
                    def projectName = sh(script: "basename `git rev-parse --show-toplevel`", returnStdout: true).trim()
                    def messageToSend = "web ${projectName}:${env.BRANCHNAME} ${VERSION} ${env.CommitMessage}"
//                     messageToSend = messageToSend.replaceAll("#", "") // 去除所有的#字符
